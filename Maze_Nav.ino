...
byte rowPins[ROWS] = {13, 32, 33, 15}; // my pins: 15, 4, 16, 17 //connect to the row pinouts of the keypad
byte colPins[COLS] = {4, 16, 17}; //my pins: 18, 26, 25 //connect to the column pinouts of the keypad
